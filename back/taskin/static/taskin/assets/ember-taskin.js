...
define('ember-taskin/authorizers/django', ['exports', 'ember-simple-auth/authorizers/oauth2-bearer'], function (exports, _emberSimpleAuthAuthorizersOauth2Bearer) {
...
define('ember-taskin/index/controller', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Controller.extend({
    session: _ember['default'].inject.service('session'),
...
define('ember-taskin/index/route', ['exports', 'ember', 'rsvp', 'moment', 'ember-taskin/utils/poolster'], function (exports, _ember, _rsvp, _moment, _emberTaskinUtilsPoolster) {
  exports['default'] = _ember['default'].Route.extend( /*AuthenticatedRouteMixin,*/{
    session: _ember['default'].inject.service('session'),
    poolster: _emberTaskinUtilsPoolster['default'].create(),
    ...
    startWatchingTime: function startWatchingTime(controller) {
      var self = this;
      controller.set('currentTime', (0, _moment['default'])());
    ...
    startWatchingTask: function startWatchingTask(controller, user) {
      var self = this;
...
define('ember-taskin/projects/route', ['exports', 'ember', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
  exports['default'] = _ember['default'].Route.extend(_emberSimpleAuthMixinsAuthenticatedRouteMixin['default'], {
    i18n: _ember['default'].inject.service(),
    model: function model() {
...
define('ember-taskin/utils/poolster', ['exports', 'ember'], function (exports, _ember) {
